...
use crate::v2::engine::start_engine;
use crate::v2::price_feed::run_price_feed;
use crate::v2::order_generator::run_order_generator;
use crate::v2::reporting::run_reporting;
...
pub async fn testv2() {
    ...
    tx.send(crate::v2::engine::Message::Shutdown).await.unwrap();
}
